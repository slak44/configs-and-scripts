...
src2dest["Scripts/mem-usage.kts"]="$HOME/Scripts/mem-usage.kts"
src2dest["Scripts/mem-usage.sh"]="$HOME/Scripts/mem-usage"
...
src2dest["Scripts/print-chromium-pss.sh"]="$HOME/Scripts/print-chromium-pss"
